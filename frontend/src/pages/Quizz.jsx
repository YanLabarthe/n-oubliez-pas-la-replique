...
export default function Quizz({ alias, onFinished }) {
  ...
  return (
    <div className="m-0 flex flex-col h-screen w-full border-amber-100 overflow-hidden">
      {/* ------- Header du Chat / là où s'affiche le statut de Batman------- */}
      <div className="p-4 flex flex-row justify-between items-center shadow bg-amber-400">
        <div className="flex">
          <div className="w-12 h-12 mr-4 relative flex flex-shrink-0">
            <BatFace face={batFace} />
          </div>
          <div className="text-sm text-gray-900 sm:flex sm:flex-col items-start">
            <p className="font-bold pt-2 text-2xl sm:pt-0 sm:text-base">
              Batman
            </p>
        ...
        <div className="flex">
          <span className="hidden sm:block text-2xl text-neutral-900 rounded-full p-10 py-2 ml-4">
      ...
      <div className="chat_body flex flex-col grow overflow-auto text-neutral-900">
        <div className="p-2">
        ...
        {timerEnded && (
          <Link
            className="py-3 mx-20 sm:py-5 sm:px-10 flex justify-center sm:my-10 sm:w-13 sm:ml-60 sm:mr-60 bg-yellow-500 hover:bg-neutral-900 hover:text-yellow-500 hover:border-yellow-500 text-white-700 font border border-current hover:border-transparent rounded "
            to="/scoreboard"
          >
            Scoreboard
          </Link>
